...
| Avatar | `minidenticons` pour les comptes; sprites Pixi pour la presence dans une room |
...
| Joueur | `/parties` | Catalogue filtrable | Tabs, Input, Card, Progress, Badge | Detail par route | SessionService |
| Joueur | `/parties/[code]` | Detail et reservation | Card, Progress, Button | Confirmation paiement | Participation + Payment |
...
| Joueur | `/parties/[code]/room` | Room sociale 2D | Pixi canvas, Card, ScrollArea, Avatar | Chat / audio | LiveAccess + Colyseus |
...
| Admin | `/` | Dashboard operationnel | MetricCard, Table, Card | Fiche session en Sheet | AdminService |
